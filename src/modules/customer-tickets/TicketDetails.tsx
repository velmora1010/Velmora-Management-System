...
import { Save, ArrowLeft, Trash2, Image as ImageIcon, RefreshCw, X, Download, Upload, FileText, CheckCircle2, AlertCircle } from 'lucide-react';
...
export const TicketDetails = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      {/* RESOLUTION WORKFLOW MODAL (STEP 1: DETAILS FORM) */}
      {showResolveModal && !showConfirmResolveDialog && ticket && (
      ...
      {showResolveModal && showConfirmResolveDialog && ticket && (
        <ConfirmResolutionModal
          ...
          onBackToEdit={() => setShowConfirmResolveDialog(false)}
