...
export { 
  parseToYMD, 
  calculateDraftDate, 
  calculatePostDateFromDraft,
  formatDisplayDateLocal,
  formatHistoryTimestamp
} from '../../utils/influencerDateUtils';
import { parseToYMD, calculateDraftDate } from '../../utils/influencerDateUtils';
  ...
  const addInfluencer = async (influencerData: Partial<CampaignInfluencer>): Promise<boolean> => {
    ...
    try {
        ...
        const infoPayload: Record<string, any> = {
          ...
          payment_method: influencerData.payment_method || (influencerData.upi_number ? 'UPI' : (influencerData.account_number ? 'ACCOUNT_DETAILS' : null)),
          upi_number: influencerData.upi_number !== undefined ? influencerData.upi_number : null,
          account_holder_name: influencerData.account_holder_name !== undefined ? influencerData.account_holder_name : null,
          account_number: influencerData.account_number !== undefined ? influencerData.account_number : null,
          ifsc_code: influencerData.ifsc_code !== undefined ? influencerData.ifsc_code : null,
          bank_name: influencerData.bank_name !== undefined ? influencerData.bank_name : null,
  ...
  const updateInfluencer = async (id: string, influencerData: Partial<CampaignInfluencer>): Promise<boolean> => {
    ...
    try {
      ...
      const rawUpdatePayload: Record<string, any> = {
        ...
        alternative_number: influencerData.alternative_number,
        email: influencerData.email,
        payment_method: influencerData.payment_method !== undefined ? influencerData.payment_method : undefined,
        upi_number: influencerData.upi_number !== undefined ? influencerData.upi_number : undefined,
        account_holder_name: influencerData.account_holder_name !== undefined ? influencerData.account_holder_name : undefined,
