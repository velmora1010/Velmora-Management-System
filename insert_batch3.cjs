...
const proposed = [
    {keyword: 'zguard', department: 'Operations', category: 'Procurement (Raw Materials)', sub_category1: 'Surfactants', sub_category2: 'SLES', vendor: 'ZGUARD', priority: 50, is_active: true},
    {keyword: 'vinayagapl', department: 'Operations', category: 'Packaging Department', sub_category1: 'Primary Packaging', sub_category2: 'Bottles', vendor: 'Vinayaga Plastics', priority: 50, is_active: true},
    {keyword: 'whiteflower10bo', department: 'Operations', category: 'Procurement (Raw Materials)', sub_category1: 'Fragrances', sub_category2: 'Detergent', vendor: 'Erode Scientific', priority: 50, is_active: true}
];
