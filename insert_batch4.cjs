...
const proposed = [
    {keyword: 'dovefragrance24', department: 'Operations', category: 'Procurement (Raw Materials)', sub_category1: 'Fragrances', sub_category2: 'Detergent', vendor: 'Erode Scientific', priority: 50, is_active: true},
    {keyword: 'ncap10ltr', department: 'Operations', category: 'Procurement (Raw Materials)', sub_category1: 'Base Chemicals', sub_category2: 'N-CAP', vendor: 'Vinayaka Chemicals', priority: 50, is_active: true}
];
